package com.wdz.module_communication.main.iot.soundanalysis.thread;
...
import com.wdz.module_communication.main.iot.soundanalysis.activity.SoundActivity;
import com.wdz.module_communication.main.iot.soundanalysis.domain.Sound;
import com.wdz.module_communication.main.iot.soundanalysis.utils.FFT;
import com.wdz.module_communication.main.iot.soundanalysis.utils.VoiceUtil;
...
//    private static final int[] SAMPLE_RATES_LIST = {11025, 8000, 22050, 44100, 16000};
     ...
     * 可能存在的采样频率
     */
    private static final int[] SAMPLE_RATES_LIST = {44100};
    /**
     * 采样频率对应的采样点数
     */
