package com.wdz.module_customview.myview.titlebar;
...
public class CommonTitleBar extends ConstraintLayout {
    ...
    private void initStyle(Context context,AttributeSet attrs) {
        ...
        if (typedArray.hasValue(R.styleable.CommonTitleBar_icon_back)){
            backImg.setImageResource(typedArray.getResourceId(R.styleable.CommonTitleBar_icon_back,R.mipmap.ic_close));
        }
        //左二图标 -- 预留
        if (typedArray.hasValue(R.styleable.CommonTitleBar_icon_left)){
            leftImg.setImageResource(typedArray.getResourceId(R.styleable.CommonTitleBar_icon_left,R.mipmap.ic_close));
        }
        //最右侧图标 -- close
        if (typedArray.hasValue(R.styleable.CommonTitleBar_icon_right)){
            rightImg.setImageResource(typedArray.getResourceId(R.styleable.CommonTitleBar_icon_right,R.mipmap.ic_close));
        }
        //右二图标 -- 一般为设置图标...
        if (typedArray.hasValue(R.styleable.CommonTitleBar_icon_close)){
            closeImg.setImageResource(typedArray.getResourceId(R.styleable.CommonTitleBar_icon_close,R.mipmap.ic_close));
        }
    }
