package com.wdz.module_customview.main.recyclerview.delete;
...
public class DeleteRecyclerViewItem extends HorizontalScrollView {
    public static boolean isLeft=true;//在左边

    public DeleteRecyclerViewItem(Context context) {
        super(context);
        init();
    }

    public DeleteRecyclerViewItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DeleteRecyclerViewItem(Context context, AttributeSet attrs, int defStyleAttr) {
