...
import com.wdz.module_customview.main.materialdesign.testBehavior.source.ViewOffsetBehavior;


import java.lang.ref.WeakReference;

public class MainHeaderBehavior extends ViewOffsetBehavior<View> {
    private static final String TAG = "MainHeaderBehavior";
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, View child, View target, int dx, int dy, int[] consumed) {
        ...
        Log.i(TAG, "onNestedPreScroll: dy:"+dy +" scrollY:"+scrollY+" child.getTranslationY():"+child.getTranslationY()+" height"+child.getMeasuredHeight());
        if (target instanceof NestedLinearLayout) {//处理header滑动
            float finalY = child.getTranslationY() - scrollY;
            Log.i(TAG, "onNestedPreScroll: finalY:"+finalY);
