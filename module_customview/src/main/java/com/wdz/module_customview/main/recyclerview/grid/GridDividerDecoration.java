package com.wdz.module_customview.main.recyclerview.grid;
...
public class GridDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        int spanCount = ((GridLayoutManager) parent.getLayoutManager()).getSpanCount();//4
        int orientation = ((GridLayoutManager) parent.getLayoutManager()).getOrientation();//1
