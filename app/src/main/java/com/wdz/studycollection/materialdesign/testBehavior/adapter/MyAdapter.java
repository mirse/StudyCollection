package com.wdz.studycollection.materialdesign.testBehavior.adapter;
...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_item_mood_card, parent, false);
