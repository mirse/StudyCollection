...
public class PageRecyclerView extends ConstraintLayout {
    ...
    public void setAdapter(Context context, LinearLayoutManager layoutManager, List<SnapHelperActivity.Item> datas){
        this.context = context;
        this.layoutManager = layoutManager;
        rv.setLayoutManager(layoutManager);
        PagerSnapHelper snapHelper = new PagerSnapHelper();
        snapHelper.attachToRecyclerView(rv);
        SnapAdapter snapAdapter = new SnapAdapter(resetData(datas),context);
